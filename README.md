...
# inserts free-form text into autogenerated --help output
# text appears at the position where ADD_HELP is declared
# may be used several times
ADD_HELP("some section title")
